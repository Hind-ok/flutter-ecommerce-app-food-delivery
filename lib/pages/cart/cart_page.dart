        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
            return _cartController.getItems.length>0?Positioned(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                      ...
                                      if(popularIndex>=0){
                                        Get.toNamed(RouteHelper.getPoularFood(popularIndex, "cartpage"));
                                      } else{
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              padding: EdgeInsets.only(top: Dimensions.height10,bottom: Dimensions.height10,left: Dimensions.width10,right: Dimensions.width10),//dar f top o l bottom width20
                ...
                )):NoDataPage(text: "Your cart i empty!");
          })
        ],
      ),
